...
import com.example.ecotrip_2026.ui.screens.FormularioScreen
import com.example.ecotrip_2026.ui.screens.ResumenScreen
...
fun EcoTripNavHost(navController: NavHostController) {
    NavHost(
        ...
        composable<ResumenRoute> { backStackEntry ->
            val resumenRoute = backStackEntry.toRoute<ResumenRoute>()
